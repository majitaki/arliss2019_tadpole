...
const static unsigned int NAVIGATING_NEAR_ABORT_TIME = 600; //near navi abort time for each
const static unsigned int NAVIGATING_START_ABORT_TIME = 5; //secnd for reboot 
